...
class Experiment:
    ...
    def _build_salience_generator(self):
        ...
        salience_cfg = self.cfg.get("salience", {})
        ...
        self.salience_gen = SalienceGenerator(**kwargs)
    
        print("=== Salience Enabled ===")
        print(f"Plugin: {plugin_name}")
        print(f"delta_theta: {kwargs['delta_theta']}")
        print(f"delta_sigma: {kwargs['delta_sigma']}")
        print(f"K: {kwargs['K']}")
        if "alpha" in kwargs:
