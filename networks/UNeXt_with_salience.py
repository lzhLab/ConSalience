# -*- coding: utf-8 -*-
"""
Implementation of the UNeXt network with Salience Generator for image segmentation tasks.
This network combines the UNeXt architecture with a salience generator to highlight important regions.
...
class UNeXt_WithSalience(nn.Module):
    """
       ...
       4) Upsampling Path: gradually restore the spatial dimensions through transposed convolutions.
    ...
    def __init__(self, in_channels, n_classes, img_dim, feature_scale=4, is_deconv=True, is_batchnorm=True):
        super(UNeXtWithSalience, self).__init__()
