# -*- coding: utf-8 -*-
"""
Implementation of the TransUNet network for image segmentation tasks.
TransUNet combines the strengths of CNN and Transformer architectures.

Original TransUNet paper:
...
class TransUNet(nn.Module):
    """
        ...
        Filters are calculated based on feature_scale to adjust network complexity.
    """
    ...
    def _create_transformer(self, input_dim, num_layers, num_heads):
        """
           Build a Transformer encoder using TransformerEncoderLayer.
           The Transformer processes features to capture long-range dependencies.
        """
...
class UnetUp2(nn.Module):
    """
       UnetUp2 blocks combine features from the downsampling path and the Transformer output.
       Blocks gradually restore spatial dimensions through upsampling or transposed convolutions.
    """
